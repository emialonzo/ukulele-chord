    ...
    buildDiagram = (nut = false) => {
        return (
            <svg id="svg153" width="104" height="118" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 104 118">
                ...
                <text id="fret" x="24.9464" y="41.382812" fill="#424242" fontFamily="sans-serif" fontSize="9.733px" letterSpacing="0px" strokeWidth=".24332" text-align="end" textAnchor="end" wordSpacing="0px" style={{lineHeight: 1.25}} xmlSpace="preserve"><tspan id="fret-value" x="24.9464" y="41.382812" fill="#424242" fontSize="10.667px" strokeWidth=".24332" text-align="end" textAnchor="end">13º</tspan></text>
                <text id="text2727" x="52.091145" y="18.297945" fill="#424242" fontFamily="sans-serif" fontSize="13.333px" letterSpacing="0px" wordSpacing="0px" style={{lineHeight: 1.25}} xmlSpace="preserve"><tspan id="tspan2725" x="52.091145" y="18.297945" fill="#424242" fontFamily="sans-serif" fontWeight="bold" text-align="center" textAnchor="middle">C/Majmen7/9</tspan></text>
            </svg>
        )
    };
